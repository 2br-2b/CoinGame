...
public class Store extends ListenerAdapter {
	...
	public static Upgrade[] randomStuff = { new Upgrade("Batarang", 10000, 14, 10),
			...
			new Upgrade("Crisp $1,000,000 bill", 999999, 0, 100), new Upgrade("Darth Vader's Helmet", 1138000, 1138, 1),
			new Upgrade("Kylo Ren's Helmet", 200000, 135, 1), new Upgrade("All of the Pokemon", 1510000, 809, 1),
			new Upgrade("Shield", 5000, 1, 200), new Upgrade("Mario's Hat", 100000, 100, 1),
			new Upgrade("Popcorn", 1000, 1, 100), new Upgrade("Debug Byte", 1, 0, 256),
			...
			new Upgrade("iPhone XR", 100000, 1, 1), new Upgrade("Stormtrooper Helmet", 100000, 5, 10),
			new Upgrade("Diamond Armor", 5307786900L, 1000, 1), new Upgrade("Wayne Manor", 800000000, 150000, 1),
			new Upgrade("Because I'm Batman!", 682450750, 54321, 1),
